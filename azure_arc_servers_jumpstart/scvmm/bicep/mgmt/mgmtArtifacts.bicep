...
param dcSubnetName string = 'SCVMM-DC-Subnet'
...
resource arcVirtualNetwork 'Microsoft.Network/virtualNetworks@2022-01-01' = {
  ...
  properties: {
    ...
    subnets: (deployBastion == false ) ? union(primarySubnet,DCSubnet) : (deployBastion == true ) ? union(primarySubnet,bastionSubnet,DCSubnet) : primarySubnet
  }
}
